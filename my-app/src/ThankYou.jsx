...
function ThankYou() {
  return (
    <div className="bg-gradient-to-br from-white via-green-50/40 to-green-200/20 min-h-screen text-green-900 overflow-x-hidden relative">
      ...
      >
        <motion.h1 className="text-xl mt-8 sm:mt-1 sm:text-5xl md:text-6xl font-black text-center mb-8 bg-gradient-to-r from-green-600 via-green-400 to-green-800 bg-clip-text text-transparent leading-tight" variants={fadeInUp}>
          You're In. We'll Be In Touch Soon.
        </motion.h1>
        <motion.div className="mb-4 sm:mb-10 text-center" variants={fadeInUp}>
          <div className="text-md sm:text-3xl font-bold text-green-700 mb-2">Thank You for Applying to the Monk Growth Grant</div>
          <div className="text-sm sm:text-xl text-green-700">We've received your pitch. And we're genuinely excited to read your story.<br />This isn't just a formality — it's the first step in a partnership that could change your brand's trajectory.</div>
        </motion.div>
        <motion.div className="flex flex-col gap-4 sm:gap-8 mb-12 sm:mt-1 mt-14" variants={staggerContainer}>
          <div className="bg-gradient-to-br from-white to-green-50/30 rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 flex flex-col gap-2 border border-green-100">
            ...
            <div className="text-green-700 sm:text-auto text-sm">Our senior team personally reviews each application, focusing on:</div>
            <ul className="list-disc ml-6 text-green-700 sm:text-auto text-sm">
              <li>Founder intent and backstory</li>
              <li>Product-market clarity</li>
              <li>Platform readiness and category potential</li>
            </ul>
            <div className="text-green-700 mt-2 sm:text-auto text-sm">We look beyond numbers. We look for grit, vision, and momentum.</div>
          </div>
          <div className="bg-gradient-to-br from-white to-green-50/30 rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 flex flex-col gap-2 border border-green-100">
            ...
            <div className="text-green-700 sm:text-auto text-sm">You'll hear from us within 7–10 days to set up a 1-on-1 discovery call. This will help us understand your challenges, product strengths, and growth goals.</div>
          </div>
          <div className="bg-gradient-to-br from-white to-green-50/30 rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 flex flex-col gap-2 border border-green-100">
            ...
            <div className="text-green-700 sm:text-auto text-sm">We only choose 1 brand per quarter. If you're selected, we'll handle your full-stack ecommerce growth for 90 days — with zero base fees and 100% commitment from our Monk team.<br />No shortcuts. No excuses. Just pure hustle + performance.</div>
          </div>
          <div className="bg-gradient-to-br from-white to-green-50/30 rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 flex flex-col gap-2 border border-green-100">
            ...
            <div className="text-green-700 sm:text-auto text-sm">We'll still:</div>
            <ul className="list-disc ml-6 text-green-700 sm:text-auto text-sm">
            ...
            <div className="text-green-700 mt-2 sm:text-auto text-sm">Because if you showed up for your brand today, we want to show up for you.</div>
          </div>
        </motion.div>
        <motion.div className="mb-12 flex justify-center" variants={fadeInUp}>
          <div className="w-full max-w-md bg-green-50/70 border border-green-100 rounded-2xl p-4 flex flex-col items-center gap-3 shadow-md">
            <div className="text-lg sm:text-2xl font-bold text-green-700 flex items-center gap-2 mb-1"> Got Questions?</div>
        ...
        <motion.div className="mb-[-20px] text-center" variants={fadeInUp}>
          <div className="text-sm sm:text-xl text-green-700 font-semibold"><span className="text-black font-bold">Remember :</span> This isn't a pitch. It's a belief.<br />We believe in brands that are built with heart, not hype.<br />And we can't wait to see what we build together.</div>
        </motion.div>
      </motion.main>
      <style>{`
