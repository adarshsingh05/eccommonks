    ...
    <div className="bg-gradient-to-br from-white via-green-50/40 to-green-200/20 min-h-screen text-green-900 overflow-x-hidden relative">
      ...
      >
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">1. Information We Collect</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">2. How We Use Your Information</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">3. Data Sharing & Disclosure</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">4. Your Rights</div>
          ...
          <div>To make a request, email us at: <a href="mailto:hello@theecommonks.com" className="underline hover:text-green-600">hello@theecommonks.com</a></div>
        </motion.div>
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">5. Data Storage & Security</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">6. Use of Cookies</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">7. Third-Party Links</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">8. Children's Privacy</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">9. Changes to This Policy</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-green-700 mb-2">10. Contact Us</div>
          <div>For any questions about this Privacy Policy or how we handle your data:<br />📧 <a href="mailto:hello@theecommonks.com" className="underline hover:text-green-600">hello@theecommonks.com</a><br />📍 A unit of 93 Communications,, Noida, India</div>
        </motion.div>
        <motion.div className="mb-8 text-base sm:text-lg text-green-700" variants={fadeInUp}>
