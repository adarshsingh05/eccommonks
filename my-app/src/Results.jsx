...
function Results() {
  return (
    <div className="bg-gradient-to-br from-green-50 via-green-100/30 to-green-200/20 min-h-screen text-green-900 overflow-x-hidden">
      ...
      >
        <motion.h1 className="text-4xl sm:text-6xl md:text-7xl font-black text-center mb-8 bg-gradient-to-r from-green-600 via-green-400 to-green-800 bg-clip-text text-transparent leading-tight" variants={fadeInUp}>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12 items-center justify-center">
          <ThreeDCard className="w-full md:w-1/2 p-6 bg-gradient-to-br from-white to-green-50/30">
            <motion.blockquote className="italic text-green-700 text-xl sm:text-2xl leading-relaxed text-center" variants={fadeInUp}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <ThreeDCard className="p-6 flex flex-col gap-2 bg-gradient-to-br from-green-50 to-white">
        ...
        <ThreeDCard className="p-8 mb-8 bg-gradient-to-br from-white to-green-50/30">
          <motion.blockquote className="italic text-green-700 text-xl sm:text-2xl leading-relaxed text-center max-w-3xl mx-auto" variants={fadeInUp}>
          ...
          <motion.p className="text-lg sm:text-xl text-center text-green-600 mt-6" variants={fadeInUp}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <ThreeDCard className="p-6 bg-gradient-to-br from-green-50 to-white">
            <div className="font-bold text-green-700 mb-2">Suppressed Listings</div>
          ...
          <ThreeDCard className="p-6 bg-gradient-to-br from-green-50 to-white">
            <div className="font-bold text-green-700 mb-2">30% Return Rate</div>
          ...
          <ThreeDCard className="p-6 bg-gradient-to-br from-green-50 to-white">
            <div className="font-bold text-green-700 mb-2">Invisible on Zepto</div>
          ...
          <ThreeDCard className="p-6 bg-gradient-to-br from-green-50 to-white">
            <div className="font-bold text-green-700 mb-2">Ad Burn, No Sales</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <ThreeDCard className="p-6 bg-gradient-to-br from-green-50 to-white">
            <div className="font-bold text-green-700 mb-2">A.U.D.I.T. SPRINT™</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {[
            ...
            <ThreeDCard key={i} className="h-full bg-gradient-to-br from-white to-green-50/30 border-0 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-3xl p-8 text-center flex flex-col justify-between">
              <div className="text-4xl mb-4">💬</div>
              <p className="text-green-700 text-lg italic leading-relaxed mb-4">"{t.quote}"</p>
              <div className="text-green-700 font-bold text-right text-base">{t.author}</div>
            </ThreeDCard>
          ))}
        </div>
        <motion.h2 className="text-2xl sm:text-3xl font-black text-center mb-8 bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent" variants={fadeInUp}>
        ...
        <motion.p className="text-xl sm:text-2xl text-center text-green-700  font-semibold" variants={fadeInUp}>
