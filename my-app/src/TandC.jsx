    ...
    <div className="bg-gradient-to-br from-white via-blue-50/40 to-purple-50/20 min-h-screen text-slate-800 overflow-x-hidden relative">
      ...
      >
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">1. Company Identity & Structure</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">2. Services Offered</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">3. Client Responsibility</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">4. Payments & Refunds</div>
          <div>All payments must be made in advance unless otherwise agreed in writing.<br />Our refund policy is listed here: <a href="/refund" className="underline hover:text-blue-600">Refund Policy</a><br />Late payments may result in paused services or penalties.</div>
        </motion.div>
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">5. Intellectual Property</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">6. Confidentiality</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">7. Use of Website & Content</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">8. Testimonials, Case Studies, and Performance Data</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">9. Governing Law & Jurisdiction</div>
        ...
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">10. Updates to Terms</div>
          <div>We may update these Terms occasionally. Continued usage of our services after updates constitutes acceptance.</div>
        </motion.div>
        <motion.div className="mb-8" variants={fadeInUp}>
          <div className="font-bold text-blue-700 mb-2">Contact</div>
          <div>For queries or concerns, please write to:<br />📩 <a href="mailto:hello@theecommonks.com" className="underline hover:text-blue-600">hello@theecommonks.com</a><br />📍 A unit of 93 Communications, Noida, India</div>
        </motion.div>
        <motion.div className="mb-8 text-base sm:text-lg text-slate-700" variants={fadeInUp}>
