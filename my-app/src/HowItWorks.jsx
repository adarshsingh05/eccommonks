...
function HowItWorks() {
  return (
    <div className="bg-gradient-to-br from-white via-blue-50/40 to-green-50/20 min-h-screen text-slate-800 overflow-x-hidden">
      <Navbar />
      <ParallaxSection speed={0.18} direction="up" className="relative z-0">
        ...
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-blue-400/10 rounded-full blur-2xl z-0" />
      </ParallaxSection>
      <motion.main
      ...
      >
        <motion.h1 className="text-3xl sm:text-5xl md:text-6xl font-black text-center mb-8 bg-gradient-to-r from-green-600 via-blue-600 to-green-800 bg-clip-text text-transparent leading-tight" variants={fadeInUp}>
        ...
        <motion.p className="text-base sm:text-lg text-center mb-12 text-slate-500" variants={fadeInUp}>
        ...
        <div className="flex flex-col gap-10">
          {steps.map((step, idx) => (
            <ThreeDCard key={idx} className="p-6 md:p-10 bg-gradient-to-br from-white to-blue-50/30 flex flex-col gap-4 shadow-xl">
              <div className="flex items-center gap-4 mb-2">
                <span className="text-3xl md:text-4xl">{step.icon}</span>
                <span className="font-black text-xl md:text-2xl text-blue-700">{step.title}</span>
              </div>
              {step.points && (
                <ul className="list-disc ml-6 text-slate-700 text-base sm:text-lg mb-2">
              ...
              {step.youLeaveWith && (
                <div className="bg-blue-50/60 rounded-xl p-4 mt-2">
                  <div className="font-bold text-blue-700 mb-1">You leave with:</div>
                  <ul className="list-disc ml-6 text-slate-700 text-base sm:text-lg">
              ...
              {step.blueprint && (
                <div className="bg-blue-100/40 rounded-xl p-4 mt-2">
                  <div className="font-bold text-blue-700 mb-1">Your Blueprint Includes:</div>
                  <ul className="list-disc ml-6 text-slate-700 text-base sm:text-lg">
              ...
              {step.unlock && (
                <div className="bg-purple-100/40 rounded-xl p-4 mt-2">
                  <div className="font-bold text-purple-700 mb-1">What We Unlock:</div>
                  <ul className="list-disc ml-6 text-slate-700 text-base sm:text-lg">
        ...
        <motion.h2 className="text-2xl sm:text-3xl font-black text-center mt-16 mb-8 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent" variants={fadeInUp}>
          Bonus: Monk Mentality
        </motion.h2>
        <ThreeDCard className="p-8 bg-gradient-to-br from-white to-green-50/30 mb-12 flex flex-col gap-4">
          <motion.p className="text-lg sm:text-xl text-center text-slate-700 font-semibold" variants={fadeInUp}>
          ...
          <ul className="list-disc mx-auto text-slate-700 text-base sm:text-lg max-w-xl">
        ...
        <motion.h2 className="text-2xl sm:text-3xl font-black text-center mb-8 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent" variants={fadeInUp}>
          ✅ Ready to Begin?
        </motion.h2>
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          <a
            href="#apply"
            className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg text-center text-lg transition-all duration-300"
          >
            🎯 Apply Now – Get Your Free Audit
          </a>
          <a
            href="#discovery"
            className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white font-bold py-3 px-8 rounded-xl shadow-lg text-center text-lg transition-all duration-300"
          >
            📞 Book a Discovery Call
          </a>
          <a
            href="mailto:hello@theecommonks.com"
            className="w-full sm:w-auto bg-gradient-to-r from-green-400 to-blue-400 hover:from-green-500 hover:to-blue-500 text-white font-bold py-3 px-8 rounded-xl shadow-lg text-center text-lg transition-all duration-300"
          >
